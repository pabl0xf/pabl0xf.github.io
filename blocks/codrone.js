...
Blockly.Blocks['go_5'] = {
  init: function() {
    this.jsonInit({
      "message0": "go (roll %1%, pitch %2%, yaw %3%, throttle %4%, duration %5 miliseconds)",
      "args0": [{
        "type": "field_number",
        "name": "NUM0",
        "value": 0
...
Blockly.Blocks['setArmColor_junior'] = {
  init: function() {
    this.jsonInit({
      "message0": "%2 set arm color to  %1",
      "args0": [
        {
          "type": "field_colour",
          "name": "COLOUR",
...
Blockly.Blocks['setEyeLEDMode_junior'] = {
  init: function() {
    this.jsonInit({
      "message0": "%2 set eye LED mode to %1",
      "args0": [{
        "type": "field_dropdown",
        "name": "LEDMODE",
        "options": [
...
Blockly.Blocks['setArmLEDMode_junior'] = {
  init: function() {
    this.jsonInit({
      "message0": "%2 set arm LED mode to %1",
      "args0": [{
        "type": "field_dropdown",
        "name": "LEDMODE",
        "options": [
...
Blockly.Blocks['setArmMode_senior'] = {
  init: function() {
    this.jsonInit({
      "message0": "setArmMode(%1)",
      "args0": [{
        "type": "field_dropdown",
        "name": "LEDMODE",
        "options": [
...
Blockly.Blocks['setEyeMode_senior'] = {
  init: function() {
    this.jsonInit({
      "message0": "setEyeMode(%1)",
      "args0": [{
        "type": "field_dropdown",
        "name": "LEDMODE",
        "options": [
...
Blockly.Blocks['setLEDto_junior'] = {
  init: function() {
    this.jsonInit({
      "message0": "%2 set LED lights to %1",
      "args0": [{
        "type": "field_dropdown",
        "name": "LEDCOLOR",
        "options": [
